...
exports.moment = exports.merged = undefined;

var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };

var _objMerged = __webpack_require__(206);
 ...
 * @return {string}
 */
Tool.getQuery = function (params) {
    var result = window.location.search.match(new RegExp("(\\?|&)" + params + "=([^&]*)(&|$)"));
    return result ? decodeURIComponent(result[2]) : null;
};

Tool.replaceAll = function (strOrg, strFind, strReplace) {
...
// 本地缓存设置
Tool.setLocalStorage = function (key, value, timeout) {
 ...
 * 参数：默认版本(默认为8.0)
 */
Tool.isIElt = function () {
    var DEFAULT_VERSION = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "8.0";
...
Tool.searchRight = function (k, v, range) {
    var start = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;

    var l = -1;
    for (var i = range.length - 1 - start; i >= 0; i--) {
        if (range[i][k] === v) {
            l = i;
            break;
        }
...
Tool.type = function (obj) {
    ...
    "Boolean Number String Function Array Date RegExp Object Error".split(" ").map(function (name, index) {
 ...
 * unit 单位
 */
Tool.milliFormat = function (s) {
    var fixed = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4;
 ...
 * 根据value值获取涨跌颜色
 */
Tool.RiseFallColor = function (value) {
 ...
 * 判断是否为有空
 */
Tool.isNotBlank = function (value) {
    if (value === null || value === undefined || value !== value || value === 'null' || value === 'undefined' || value === 'NaN' || value === '') {
        return false;
    } else {
        var jsonStr = null;
        try {
 ...
 * 简单判断数组对象的指定的值是否相等
 */
Tool.isArrayContainerValue = function (array, key, value) {
    var flag = false;
 ...
 * order
 */
Tool.arrayCompare = function (arr1, arr2, key) {
    var order = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
 ...
 * 当传入值为无效值时返回'--',否则原样返回
 */
Tool.friendlyString = function (value) {
    var defaultValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '--';

    if (value === null || value === undefined || value !== value || value === 'null' || value === 'undefined' || value === 'NaN' || value === '' || value === false) {
        return defaultValue;
    } else {
        return value;
    }
 ...
 * 格式化输出日期
 */
Tool.formatDateTime = function () {
    var date = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    var format = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "YYYY-MM-DD HH:mm:ss";

    var d = (0, _moment2.default)(date, format).format(format);
 ...
 * 根据天数格式化输出，X年X月
 */
Tool.friendlyDays = function (days) {
    var start_data = (0, _moment2.default)().subtract(days, 'days').format('YYYY-MM-DD');
    return Tool.ggYYMM(start_data);
};
/**
 * 根据开始时间&结束时间格式化输出，X年X月
 */
Tool.ggYYMM = function (start_date, end_date) {
    if (start_date === null) return '--';
    var total_months = (0, _moment2.default)(end_date || new Date()).diff((0, _moment2.default)(start_date), 'months');
    var total_years = parseInt(total_months / 12);
 ...
 */
Tool.friendlySize = function (size) {
    var gear = [1, 1000, 1000, 1000];
    var fixed = [0, 0, 1, 2];
    var unit = ['字节', 'KB', 'MB', 'GB'];

    var calc = function calc(size) {
 ...
 * 验证手机号
 */
Tool.isMobile = function (v) {
    return !!/^1[3|4|5|7|8][0-9]\d{8}$/.test(v);
};
/**
 * 验证邮箱
 */
Tool.isEmail = function (v) {
...
function makeApiParams(params) {
    ...
    if (params && Object.prototype.toString.call(params) === '[object Object]') {
        for (var key in params) {
            ...
            if (typeof value !== 'undefined' && value !== null && value !== Infinity) {
                if (Object.prototype.toString.call(value) === '[object Array]' || Object.prototype.toString.call(value) === '[object Object]') {
                    ...
                    paramsObj[key] = _Tool2.default.replaceAll(String(value), '\\*', "");
                }
            }
        }
        ...
        for (var i in strs) {
            ...
            paramPair[1] = _Tool2.default.replaceAll(paramPair[1], '\\*', "");
            if (paramPair[0] === '') {
                continue;
                // break;
            }
...
// 下载文件，默认GET
DataService.download = function (url, params, handle) {
    ...
    var $downloader = (0, _jQuery2.default)('<div style="display: none;"><form target="' + target + '"></form><iframe name="' + target + '"></iframe></div>');
    (0, _jQuery2.default)('body').append($downloader);
    ...
    for (var key in params) {
        var value = params[key];
        var $input = (0, _jQuery2.default)('<input type="text"/>');
        $input.attr('name', key);
        $input.attr('value', value);
        $form.append($input);
    }
    var $submit = (0, _jQuery2.default)('<input type="submit"/>');
    $form.append($submit);
    $submit.click();
 ...
 */
DataService.upload = function (option) {
...
DataService.handleDataResponse = function (option) {
    var dataResponse = option.dataResponse,
        callback0 = option.callback0,
        // 请求成功
    callback1001 = option.callback1001,
        // 请求成功无数据
    ...
    dataResponse.done(function (res) {
        ...
        if (statusCode === 0) {
            ...
            if (statusCode === 1100) {
                ...
                var url = '?url=' + encodeURIComponent(pathname + hash);
...
!function (merged) {
    ...
    function isJson(obj) {
        return (typeof obj === 'undefined' ? 'undefined' : typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) == 'object' && obj !== null && Object.prototype.toString.call(obj).toLowerCase() === '[object object]' && !obj.length; //true 是 false不是
    };
